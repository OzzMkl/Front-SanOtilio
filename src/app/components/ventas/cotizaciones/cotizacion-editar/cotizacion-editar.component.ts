...
creaVenta(){
  ...
  sumaPorcentajeComi(e:any){
    if(e == true){
      ...
      this.cotizacion_editada.subtotal = 0;
      this.cotizacion_editada.total = 0;
      //Recorremos la lista de productos
      this.productos_cotizacion_e.forEach(producto =>{
        /*
        ...
        */
        ...
        this.cotizacion_editada.subtotal = this.cotizacion_editada.subtotal + (producto.precio * producto.cantidad);
        this.cotizacion_editada.total = this.cotizacion_editada.total + producto.subtotal;
      });
    } else {
