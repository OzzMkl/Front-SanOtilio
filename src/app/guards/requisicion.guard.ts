...
export class RequisicionGuard implements CanActivate {

  public user:any;
  public check: boolean = false;
  mReq = this._modulosService.modsClientes();
  ...
  private validaPermiso(){
     ...
     */
    var userPermi = this.user.permisos.find((x:any) => x.idModulo == this.mReq.idModulo && x.idSubModulo == this.mReq.idSubModulo);
